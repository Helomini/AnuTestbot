class script(object):
    START_TXT = """<b>🌹Hᴇʟʟᴏ {} 👋🏻
🔺ɪ ᴀᴍ Տᴇᴀʀᴄʜ ʙᴏᴛ <a href=https://t.me/{}>{}</a>
🔺ɪ ᴄᴀɴ Տʜᴀʀᴇ ᴍᴏᴠɪᴇՏ ᴀɴᴅ ՏᴇʀɪᴇՏ😁
 
ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ Տᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ💫😍️</b>"""
...
🔺 Lᴀɴɢᴜᴀɢᴇ: Pʏᴛʜᴏɴ 
🔺 Bᴏᴛ Sᴇʀᴠᴇʀ: Heroku
🔺 Updates Channel: <a href='https://t.me/anurinomoviezz'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""
    ...
    I_CUDNT = """<b>Sorry No Movie Found
 Your Request Movie Name -  {} 😕
...
movie की spelling को Google पर check करें |

✓ अगर आप मूवी का नाम सही भेज रहे है | और आपको मूवी नहीं मिल रही हैं तो आप उस मूवी की Request Admin से करें |
👉 जैसे - @admin + Movie Name
Note:- आपकी Request 24 घंटे के अंदर पुरी कर दी जाएगी |"""

    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ..."""

    TOP_ALRT_MSG = """Cʜᴇᴄᴋɪɴɢ Fᴏʀ Mᴏᴠɪᴇ Iɴ Dᴀᴛᴀʙᴀsᴇ..."""

    MELCOW_ENG = """<b>🌹Hᴇʟʟᴏ {} 😍, आपका स्वागत है हमारे {}! ग्रुप में! ❤

✓ आपको जो भी मूवी चाहीए उसका सही नाम लिखो 👍

✓ याद रहे spelling गलती ना करें | एक बार Google जरूर कर ले 👍

✓ सबसे जरूरी बात सिर्फ मूवी का नाम भेजे उसके साथ कोई भी फालतू का शब्द नहीं होना चाहिए |
Example:- 
Titanic ✅
Titanic Full Movie ❌
Titanic 1997 ✅
...
✓ अगर आप मूवी का नाम सही भेज रहे है | और आपको मूवी नहीं मिल रही हैं तो आप उस मूवी की Request Admin से करें |
👉 जैसे - @admin + Movie Name
Note:- आपकी Request 24 घंटे के अंदर पुरी कर दी जाएगी |</b>"""

    OWNER_INFO = """
<b>🌹ᴊᴏᴇʟ ᴋᴜʀɪᴀɴ ʙɪᴊᴜ🌹</b>"""
...
<b>☀️ Languages</b> : <code>{languages}</code></b>

<b>🔻Please click on the How To Download & Watch button👇</b>"""
