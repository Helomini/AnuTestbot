...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>CONTACT HERE 👉👉 ----> [ @Priyanka_samrottbot ] / GROUP HERE 👉👉 @Mycutiebabylovep !</b>")
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("♦ ️HOW TO DOWNLOAD & Watch ♦️", url=f"https://t.me/how_to_Download_movie_bot")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              InlineKeyboardButton("JOIN", url="https://t.me/anurinomoviezz")
                             ]
                            ]
                        )
                    )
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("♦️ Jᴏɪɴ Updates ᴄʜᴀɴɴᴇʟ ♦️", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('♦ ️MAIN CHANNEL ♦️', url="https://t.me/anurinomoviez"),
                    InlineKeyboardButton('♦️ UPDATES ♦️', url='https://t.me/anurinomoviezz')
                ],[
        ...
        buttons = [[
            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/anurinomovie")
        ],[
            InlineKeyboardButton('Hᴏᴍᴇ', callback_data='start')
        ]]
        await client.edit_message_media(
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Mycutiebabylove")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
