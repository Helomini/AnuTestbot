...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton('♦️ Join Updates Channel ♦️', url="https://t.me/anurinomoviez"
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**You are not in our Back-up channel given below so you don't get the movie file...\n\nIf you want the movie file, click on the '♦️ Join Updates Channel ♦' button below and join our Updates channel, then click on the '🔄 Try Again' button below...\n\nThen you will get the movie files...**",
